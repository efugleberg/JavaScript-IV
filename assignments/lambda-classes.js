...
class Student extends Person {
    ...
    sprintChallenge(subject) {
        console.log(`${this.student} has begun spring challenge on ${subject}`)
    }
}
...
class ProjectManagers extends Instructor {
  ...
  const biebs = new ProjectManagers({
    ...
    catchPhrase: `Don't forget the homies`,
    gradClassName: 'WEB14',
    favInstructor: 'Dr. Phil'
  });

  console.log(margaret);
  fred.demo('React');
  fred.grade(margaret, 'React');
  margaret.listsSubjects();
  margaret.PRAssignment('JS-IV');
